...
from sdlc_mcp.engine.debate_runtime import DebateRuntime, _agent_roles_for_phase
...
from sdlc_mcp.runtime.tools.phase import (
    _debate_dict,
...
class TestDebateDict:
    ...
    def test_transcript_no_consensus(self) -> None:
        from sdlc_mcp.models import DebateTranscript as DT
