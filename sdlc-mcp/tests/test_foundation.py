...
from sdlc_mcp import FailureType, SDLCError, Task
from sdlc_mcp.config import Settings
from sdlc_mcp.exceptions import ConfigError, StoreError
...
class TestExceptions:
    ...
    def test_exception_inheritance(self) -> None:
        from sdlc_mcp.exceptions import (
            CheckpointError,
            DebateError,
            JudgeError,
            ModelError,
...
class TestConfig:
    def test_settings_defaults(self) -> None:
        ...
        assert settings.llm.default_provider == "opencode"
        assert settings.llm.default_model == "opencode/current"
