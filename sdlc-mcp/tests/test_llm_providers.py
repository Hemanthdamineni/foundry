...
from sdlc_mcp.adapters.llm import FakeProvider, ModelRouter, OllamaProvider, OpenAIProvider
...
class TestOpenAIProvider:
    ...
    async def test_healthcheck_returns_false_bad_key(self) -> None:
        p = OpenAIProvider(api_key="sk-bad", base_url="http://127.0.0.1:19999/v1", timeout_s=1)
        assert await p.healthcheck() is False
