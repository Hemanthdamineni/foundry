...
from foundry.core.models import FailureType
from foundry.features.sdlc_runtime.validators.deterministic.results import ValidationReport, ValidationResult

if TYPE_CHECKING:
    from foundry.features.sdlc_runtime.adapters.base import ToolAdapter, ToolCapability
